...
class DatasetConfig:
    batch_size: int = 64 # 原本是 64，調小 bath size，使用 bz=16 訓練，搭配 lr=0.00005，使用 bz = 256 評估訓練完的模型
    ...
    path: Dict = dataclasses.field(default_factory=lambda: {
        ...
        # absolute path
        Mode.train: "C:\\Users\\Xaio\\Documents\\GitHub\\ecg-classification\\data\\mitbih_ptbdb_train_sliced.csv",
        Mode.eval: "C:\\Users\\Xaio\\Documents\\GitHub\\ecg-classification\\data\\mitbih_ptbdb_test_sliced.csv"
...
class ModelConfig:
    ...
    signal_length: int = 15  # 原本是 187
    num_classes: int = 6      # 輸出分類
    input_channels: int = 1   # 輸入訊號的通道數
    embed_size: int = 16     # Transformer 的維度大小，原本是 192
